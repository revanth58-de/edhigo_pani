...
export default {
  ...
  auth: {
    ...
    iAmMachineryOwner: 'I am a Machinery Owner',
    machineryDesc: 'Register machinery & accept bookings.',
    register: 'Register',
    fullName: 'Full Name',
    village: 'Village',
  ...
  machinery: {
    ...
    bookingSuccessMessage: 'Your booking for %{name} on %{date} (%{slot}) has been confirmed.',
    noListings: 'No available listings for %{type} nearby.',
    errorBooking: 'Error booking machinery',
    errorLoading: 'Error loading listings',
    pricePerHour: '₹%{price}/hour',
    ratingBookings: '%{rating} (%{count} bookings)',
    slots: {
      morning: 'Morning (6 AM - 12 PM)',
      afternoon: 'Afternoon (12 PM - 6 PM)',
      fullDay: 'Full Day'
    },
    myMachinery: 'My Farm Machinery',
    registerNew: 'Register New Machine',
    machineName: 'Machine Name (e.g. John Deere 5050)',
    machineType: 'Machine Type',
    hourlyRate: 'Hourly Rate (₹/hour)',
    registerButton: 'Register Machine',
    successRegister: 'Machine registered successfully!',
    errorRegister: 'Failed to register machinery.',
    ownerBookings: 'Reservations & Bookings',
    noRegistered: 'You have not registered any machinery yet.',
    noOwnerBookings: 'No bookings on your machinery yet.',
    activeListings: 'My Machines',
    rateRequired: 'Please input a valid hourly rate.',
    nameRequired: 'Please input machine name.',
