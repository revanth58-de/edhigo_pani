// Group Leader QR Scanner — PhonePe Style UI
// Leader scans the farmer's QR code to mark group attendance in real time
...
const HELP_STEPS = [
  {
    ...
    title: "Point camera at farmer's QR",
    desc: 'Ask the farmer to open their Check-In / Check-Out screen. Hold your phone steady and align the QR code inside the frame.',
  },
  {
    icon: 'location-on',
    title: 'Allow location access',
    desc: 'Your location is needed to confirm your group is at the farm when checking in or out.',
  },
  {
    icon: 'groups',
    title: 'Attendance for whole group',
    desc: 'Scanning once marks attendance for you and your group on this job.',
  },
  {
    icon: 'flashlight-on',
  ...
  },
  {
    ...
    desc: 'After a successful scan you will see a confirmation screen.',
  },
];
  ...
  const processQRData = async (data) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        navigation.replace('GroupAttendanceConfirmed', {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topHeader}>
        ...
        <Text style={styles.headerTitle}>Scan {type === 'IN' ? 'Check-In' : 'Check-Out'}</Text>
           ...
           <View style={styles.overlayRowBottom}>
              <View style={styles.overlayDark}>
                 <Text style={styles.instructionText}>
                    Align Farmer's QR within frame to scan
                 </Text>
              </View>
           </View>
        </View>
